/*
  ...
  1. Schema Changes
    - Create new 'app' schema
    - Move existing tables from public to app schema:
      - generated_app
      - chat  
      - message
  ...
  2. Security
    - Enable RLS on all tables in new schema
    - Recreate policies for all tables in app schema
    - Drop old policies from public schema
*/
